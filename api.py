...
def load_url_file(img_name, url, mode='RGB'):
    """
    Loads an image file (.jpg, .png, etc) from a given url into a numpy array

    :param img_name: the user's desired name for the image file
