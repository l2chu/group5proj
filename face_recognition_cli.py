...
def test_image(image_to_check, known_names, known_face_encodings, tolerance=0.6, show_distance=False, name=''):
    if name != '':
        unknown_image = face_recognition.load_url_file(name, image_to_check)
    else:
...
def main(known_people_folder, file_source, cpus, tolerance, show_distance, name=''):  ## notice new name='' parameter ##
